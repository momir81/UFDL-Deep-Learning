...
[sae1OptTheta,cost] = minFunc(@(p) sparseAutoencoderCost(p,inputSize,...
                      hiddenSizeL1,lambda,sparsityParam,beta,...
                      trainData),sae1Theta,options);
...
[sae2OptTheta,cost] = minFunc(@(p) sparseAutoencoderCost(p,hiddenSizeL1,...
                      hiddenSizeL2,lambda,sparsityParam,beta,...
